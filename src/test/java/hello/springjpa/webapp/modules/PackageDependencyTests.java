...
public class PackageDependencyTests {
    ...
    @ArchTest
    ArchRule modulesPackageRule = classes().that().resideInAPackage("hello.springjpa.webapp.modules..")
            .should().onlyBeAccessed().byClassesThat()
            .resideInAnyPackage("hello.springjpa.webapp.modules..");
    ...
    @ArchTest
    ArchRule cycleCheck = slices().matching("hello.springjpa.webapp.modules.(*)..")
